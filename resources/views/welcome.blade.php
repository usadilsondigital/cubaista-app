        ...
        function validateForm() {
            if (document.getElementById('inlineRadio1').checked) {
              ...
              if(firstname1=="" || lastname1=="" || email1==""){
                ...
                else{return true;}/*website2 company_name2 additional_notes1 based2*/
            ...
            <div class="col-sm-8">
                ...
                <form name="myForm" action="cubaista" onsubmit="return validateForm();" method="post">
                    ...
                    <div id="myDIV2" style="display: none;">
                        ...
                        <div>
                            <input type="text" class="form-control" id="website2" placeholder="Type Website"
                                name="website2" autocomplete="off">
                        </div>
                        <div>
                    ...
                    <div id="myDIV4" style="display: none;">
                        ...
                        <div>
                            <input type="text" class="form-control" id="company_name4"
                                placeholder="Group Organizer or Company Name" name="company_name4"
                                autocomplete="off">
                        </div>
                        <div>
